...
namespace Renamer
{
  ...
  public class Helper
  {
    ...
    /// <summary>
    /// Make the first letter of every word UPPERCASE, words must be separated by space
    /// </summary>
    /// <param name="str"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Array of invalid chars to check for in path strings
    /// </summary>
    ...
    /// <summary>
    /// Determines if path string contains invalid chars
    /// </summary>
    /// <param name="path">Path to test</param>
    /// <returns>True if valid</returns>
    public static bool FilePathIsValid (string path)
    {
      return ( !string.IsNullOrEmpty ( path ) && path.IndexOfAny ( InvalidPathChars ) >= 0 );
    }
  }
}